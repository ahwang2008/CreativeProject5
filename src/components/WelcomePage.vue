<template>
  <div class="column">
    <img src="https://img-aws.ehowcdn.com/default/ehow/images/a04/qo/2o/build-shopping-cart-gokart-800x800.jpg" width="400px"/>
    <h1>Mario's Shopping Kart. A simple way to shop.</h1>
    <h2>For those who are obsessed with driving.</h2>
    <form v-on:submit.prevent="register">
      <p>1. Choose a user name (this is how you will be known by others on Mario's Shopping Kart).</p>
